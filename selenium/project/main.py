...
if __name__ == '__main__':
    case_path = r'D:\learnPY\from github\selenium\project\testcase'
    report_path = r'D:\learnPY\from github\selenium\project\report'
    ...
    runner = HTMLTestRunner_CN_Chart_Screen.HTMLTestRunner(verbosity=2, stream=fp, title='python', description='selenium')
    runner.run(suite)
    fp.close()
